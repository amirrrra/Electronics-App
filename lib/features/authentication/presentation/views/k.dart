        ...
        if (response.statusCode == 200) {
          ...
          setState(() {
            ...
            if (registrationSuccess) {
              registeredUser = UserModel.fromJson(jsonResponse['data']);
            }
          });
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  _styledField('Last Name', onChanged: (val) => lastName = val),
                  _styledField(
                    'Phone',
                    onChanged: (val) => phone = val,
                    keyboardType: TextInputType.phone,
                  ),
                  _styledField('Address', onChanged: (val) => address = val),
                  _styledField(
                    'Email',
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Created at: ${registeredUser!.createdAt}',
                            style: TextStyle(color: Colors.white),
                          ),
                        ],
                      ),
